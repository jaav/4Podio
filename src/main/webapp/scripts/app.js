...
var 4podioApp = angular.module('4podioApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', '4podioAppUtils', 'pascalprecht.translate', 'truncate']);
